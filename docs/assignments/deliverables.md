...
the event, and build a map in QGIS showing where it was held plus any other relevant mappable
information. Upload the PDF together with a brief explanation of any maps that were shown and
discussed and what you learned about professional map-based communication. Answer:

1. What data did they use to make their map?
...
Mark your attendance on Learning Suite for each Tuesday and Thursday class. At the end of the
semester, completing the course evaluation at
[studentratings.byu.edu](https://studentratings.byu.edu) earns extra credit; the instructor can
see who completed it but not the evaluations themselves. See [Grading](../policies/grading.md).
