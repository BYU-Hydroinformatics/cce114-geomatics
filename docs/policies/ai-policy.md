# CCE 114 - Geomatics: AI Use Policy

> [!IMPORTANT]
> **If you read nothing else, read this:**
> - **Use AI to learn.** We encourage full, active, healthy use of AI in this course — for studying, troubleshooting QGIS, and improving your work.
...
## 2. Quizzes
These are open-book, untimed, and designed to reinforce reading and lecture concepts — use AI freely to help clarify confusing concepts, quiz yourself, or explain textbook passages in different terms. Just make sure you understand the material yourself, since the same concepts reappear on the Concepts Exams, where AI is not allowed.
...
Some assignments are *designed* around AI: Lab 3 requires an AI-generated error report, and the Web Mapping with AI Experience is AI-assisted from the start. Each lab also ends with a short **"Using AI on This Lab"** section with specific suggestions for that lab — read it (each lab is linked from the [week](../schedule.md) it is due).
...
## 7. Community and Professional Map Experience
Feel free to use AI to help you organize your notes, refine your written reflection, or better understand the maps/data discussed at the event you attend — but the event attendance and your firsthand observations must be your own.

## 8. Web Mapping with AI Experience
This assignment is explicitly designed around AI-assisted development — use AI tools as fully and creatively as you'd like to help you build your web map.

## 9. Concepts Exams (Testing Center)
AI tools are **not permitted** during these exams. Prepare using AI beforehand as much as you like (practice questions, concept review), but the exam itself must be completed without AI assistance.

## 10. Final Exam
AI tools are **not permitted** during the exam. Use AI freely in your studying and preparation beforehand.
