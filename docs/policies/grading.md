...
The quizzes are all online through Learning Suite. They have no time limit and are meant to be
done with your notes and textbook in hand. Take the readings and quiz questions seriously and
give yourself enough time; the same concepts reappear on the Concepts Exams, where the book,
notes, and AI tools are not available.

## Academic Honesty

Everything you submit must be your own work. Read the [AI Use Policy](ai-policy.md) for how AI
fits into that, and the [University Policies](university.md) page for the Honor Code and plagiarism
standards that apply to every BYU course.
