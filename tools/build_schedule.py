...
DAYS = [
    ...
    dict(n=3, week=2, kind="hands-on", title="GIS Data Models, Part 2: Creating and Editing GIS Data",
    ...
    dict(n=5, week=3, kind="hands-on", title="Maps, Symbology, and Cartography, Part 2",
    ...
    dict(n=6, week=4, kind="concepts", title="The Global Positioning System, Part 1",
         slides=[("The Global Positioning System, Part 1", f"{SITE}/slides/day-06/gps-part-1.html")],
         topics=["How GPS and GNSS positioning work", "Latitude and longitude, precision, and error",
                 "Converting from latitude/longitude to meters, and why it is not straightforward"],
         activity="GPS class activity: walk campus, record the latitude and longitude of three locations with your phone, and enter them in the shared sheet",
         reading="GIS Fundamentals, Chapter 5 (GNSS and Coordinate Surveying)"),
    dict(n=7, week=4, kind="hands-on", title="The Global Positioning System, Part 2",
         slides=[("The Global Positioning System, Part 2", f"{SITE}/slides/day-07/gps-part-2.html")],
         topics=["GPS and triangulation / trilateration", "Where is Air Force One?", "Computing positional error"],
         activity="Where Am I: trilaterate a location on paper from signal delays and upload a photo of your solution"),
    ...
    dict(n=9, week=5, kind="hands-on", title="Working with Vector Data, Part 2",
    ...
    dict(n=11, week=6, kind="hands-on", title="Working with Raster Data, Part 2",
    ...
    dict(n=13, week=7, kind="hands-on", title="Getting Data through Web Mapping Services",
    ...
    dict(n=15, week=8, kind="hands-on", title="Geodesy, Projections, and Coordinate Systems, Part 2",
    ...
    dict(n=17, week=9, kind="hands-on", title="Metadata, Part 2",
    ...
    dict(n=19, week=10, kind="hands-on", title="Geoprocessing, Part 2",
    ...
    dict(n=20, week=11, kind="concepts", title="Geoplanning",
         topics=["Introduction to geoplanning", "Domes for the World and the Mozambique project"]),
    dict(n=21, week=11, kind="hands-on", title="Introduction to CCE 414: Engineering Applications of GIS",
         slides=[("Introduction to CCE 414", f"{SITE}/slides/day-21/intro-to-cce-414.html")],
         topics=["Preview of the follow-on course", "Engineering problems solved with GIS"],
         links=[("Prior-year recording of this lecture", "https://youtu.be/RIzy0JRB8VI")]),
    ...
    dict(n=23, week=12, kind="hands-on", title="Project Site Selection, Part 2",
         ...
         topics=["Review workflow diagrams", "Final mapping project description", "Study session for Concepts Exam 2"],
    ...
    dict(n=26, week=14, kind="other", title="Final Project Work Session",
         topics=["Work on your final project in class with Dr. Ames' help"]),
    dict(n=27, week=14, kind="other", title="Final Project Work Session",
         topics=["Work on your final project in class with Dr. Ames' help"]),
    dict(n=28, week=15, kind="other", title="Final Exam",
         topics=["The final exam is given in class in the regular classroom; see Learning Suite for the exact time",
...
WEEKS = {
    ...
    11: dict(theme="Geoplanning", due=["Lab 10"]),
    12: dict(theme="Project Site Selection", due=["Lab 11", "Concepts Exam 2 (Testing Center)"]),
    13: dict(theme="Final Project", due=[]),
    14: dict(theme="Final Project", due=["Web Mapping with AI Experience (Wednesday)", "Final Project (Saturday)"]),
