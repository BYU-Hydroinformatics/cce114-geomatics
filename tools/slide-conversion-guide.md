...
for the CCE 114 rhythm: Tuesdays are concept lectures by Dr. Ames, Thursdays are demos and
hands-on work in QGIS led by Dr. Halgren. Keep the source deck's content, order, and voice;
...
- End with a **Before Next Class** slide: the textbook reading, the open-book quiz on Learning
  ...
  session, add a short **Thursday with Dr. Halgren** preview slide before it.
